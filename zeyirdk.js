...
jsPsych.plugins["zeyirdk"] = (function() {
    ...
    const vh = Math.max(document.documentElement.clientHeight, window.innerHeight);
		...
		trial.correct_choice = assignParameterValue(trial.coherence > 0.5, undefined);
		...
		var oppositeCoherence = 1 - coherence;//trial.opposite_coherence; // The coherence for the dots going the opposite direction as the coherent dots
		...
		*/
		...
		function end_trial() {
			...
			var trial_data = {
				...
				"opposite_coherence": oppositeCoherence,
